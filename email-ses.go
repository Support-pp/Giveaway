...
func sendVerifyMessage(name string, email string) {
	//TODO: Rename function to sendSubmitMessage
	Sender := "giveaway@support-pp.de"
	Recipient := email
	Subject := "[Support++] Validation completed!"
	HtmlBody := "Ho Ho Ho "+name+",<br /> <br /> we just verified your call.<br /> Now you are in the raffle pot for the winnings.<br /> <br /> <b>Check on 23.12.2018 at 20:00 GMT+1 on YouTube to see if you have won.</b><br /> <a href=<\"https://www.youtube.com/watch?v=tiRGj6AdbCM\">https://www.youtube.com/watch?v=tiRGj6AdbCM</a><br /> <br /> Your Support++ Team"
	CharSet := "UTF-8"
